// app/pricing/page.tsx - With annual/monthly billing toggle
"use client";
...
export default function PricingPage() {
  ...
  const handlePremiumUpgrade = () => {
    ...
    // Pass billing frequency to checkout
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, you can switch between monthly and annual billing at any time. When switching to annual, you'll receive a prorated credit for your current monthly subscription."
    },
    {
      question: "Is there a free trial for Premium?",
      answer: "Contact us to discuss trial options for your specific needs. We offer custom trial periods for qualifying organizations and districts."
    },
    {
      question: "Do you offer custom enterprise plans?",
      answer: "Yes, we offer custom solutions for large districts and enterprise customers, including volume discounts, custom integrations, and dedicated support."
    },
    {
      question: "What happens to my data if I downgrade?",
      answer: "Your data remains safe and accessible. Some premium features like advanced analytics and bulk tools will be limited, but all your listings and transaction history are preserved."
    }
  ];
          ...
          <div className="rounded-2xl border-2 border-[#0A6B58] bg-white p-6 sm:p-8 shadow-sm">
            <div className="flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div className="text-right">
                {isAnnual ? (
                  <div>
                    <div className="text-xl font-semibold text-slate-900 sm:text-2xl">
                      ${annualPrice}<span className="text-base font-normal text-slate-500">/year</span>
                    </div>
            ...
            <div className="mt-8">
              {isPremium ? (
                ...
                >
                  {isSignedIn 
                    ? `Upgrade to Premium ${isAnnual ? '(Annual)' : '(Monthly)'}` 
                    : "Get Started"
                  }
                </button>
              )}

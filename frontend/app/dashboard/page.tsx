...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex h-full flex-col gap-1 rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
...
function WestlandsCard({
  ...
  return (
    <div className="group relative flex h-full min-h-[132px] flex-col rounded-xl border border-emerald-100 bg-emerald-50/70 p-3 text-right shadow-sm">
      <div className="text-[10px] font-semibold uppercase tracking-wide text-emerald-700">Westlands balance</div>
      <div className="mt-1.5 flex flex-col items-end gap-1 text-right">
        {loading ? (
